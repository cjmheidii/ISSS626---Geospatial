...
Some main characteristics of the data is as follows : - ID (acc code) - Time (Incident_datetime,report_Datetime) - Location (province_en, latitude, longitude) - reporting agency (agency) : will be used to see if the difference in agency reporting has an impact on deaths or extent of severity - Vehicle : (vehicle_type): which vehicle type is more prone to get into accidents, deaths - Cause : (presumed_cause) - Collision type : (accident_type) - Severity : factor for measurement - Environment : (weather_condition) : does the weather itself have any impact of occurance of accidents or severity of it? - Road Geometry - Slope
:::
