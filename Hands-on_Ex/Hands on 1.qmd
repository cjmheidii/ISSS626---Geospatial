...
```{r}
mpsz <- st_read("Hands-on_ex01/data/geospatial/MasterPlan2014SubzoneBoundaryNoSea.geojson")
preschools <- st_read("Hands-on_ex01/data/geospatial/PreSchoolsLocation.geojson")
cycling_path <- st_read("Hands-on_ex01/data/geospatial/CyclingPathNetworkGEOJSON.geojson")
neighbourhoods <- st_read("Hands-on_ex01/data/geospatial/neighbourhoods.geojson")
